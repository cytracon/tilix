...
**What it is.** Cytracon Tilix is a tiling terminal for Omarchy (Arch + Hyprland). Use it as Super+Return: split panes, bookmarks, AI CLIs (Grok, Codex, or your own), and ops commands. Shop hosts and SSH paths stay in your Preferences — they are not shipped here. `omarchy install tilix` also enables the bar plugin.
